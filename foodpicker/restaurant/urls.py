...
urlpatterns = [
    ...
    path('google-restaurant/<str:place_id>/', views.get_google_restaurant_detail, name='google_restaurant_detail'), #for Google Places restaurant detail
    path('google-test/', views.google_restaurant_test, name='google_restaurant_test'), #test page for Google Places
    ...
    path('google_places_restaurants/', views.google_places_restaurants, name="google_places_restaurants"),
